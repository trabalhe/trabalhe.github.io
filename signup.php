...
<body>
 <nav>
    <div class="nav-wrapper">
      <a href="#" class="brand-logo">Trabalhe</a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><a href="signup.php">Seja PRO</a></li>
